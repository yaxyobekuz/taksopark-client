...
import { useRestdayCreate } from "../../hooks/useRestdayMutations";

const RestDayCreateModal = ({ close, presetDriverId }) => {
  const { driverId, date, note, setField, state } = useObjectState({
  ...
  const { mutate, isPending } = useRestdayCreate();
...
export default RestDayCreateModal;
