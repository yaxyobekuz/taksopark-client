...
import { useCarDocumentTypeDelete } from "../../hooks/useCarDocumentTypeMutations";

const CarDocumentTypeDeleteModal = ({ close, docType }) => {
  const { mutate, isPending } = useCarDocumentTypeDelete();
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-muted-foreground">
        Bu turdan foydalanayotgan mashinalar bo'lsa o'chirib bo'lmaydi.
      </p>
...
export default CarDocumentTypeDeleteModal;
