...
import { getExpiryStatus, getDaysLeft } from "@/owner/features/cars/utils/expiryStatus";
...
const DriverDocumentsSection = ({ driverId, documents = [] }) => {
  ...
  return (
    <div className="space-y-3">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                variant="ghost"
                onClick={() =>
                  openModal(MODAL.DRIVER_DOC_EDIT, { driverId, document: doc })
                }
              >
                <Pencil size={14} />
              </Button>
              ...
              <Button
                ...
                variant="ghost"
                onClick={() =>
                  openModal(MODAL.DRIVER_DOC_DELETE, { driverId, document: doc })
                }
              >
      ...
      <div className="flex items-center justify-center w-full">
        <Button
          size="sm"
          onClick={() => openModal(MODAL.DRIVER_DOC_CREATE, { driverId })}
        >
