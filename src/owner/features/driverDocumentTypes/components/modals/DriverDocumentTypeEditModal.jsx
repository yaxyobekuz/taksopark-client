...
import { useDriverDocumentTypeUpdate } from "../../hooks/useDriverDocumentTypeMutations";

const DriverDocumentTypeEditModal = ({ close, docType }) => {
  ...
  const { mutate, isPending } = useDriverDocumentTypeUpdate();
...
export default DriverDocumentTypeEditModal;
